 ...
 * `WAVE_SELF_SETTLEMENT_CHECKOUT_FEE_RATE` is the fallback when a merchant has
 * no per-business `selfSettlementCheckoutFeeRate`. Fraction 0–1. Independent of
 * merchant GL `customerWalletFeeRate`.
 */
