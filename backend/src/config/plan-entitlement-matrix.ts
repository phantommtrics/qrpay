...
export const PLAN_ENTITLEMENT_SLUGS: Record<PlanCode, string[]> = {
  ...
  [PlanCode.BUSINESS_PRO]: [...BUSINESS_PRO_ENTITLEMENT_SLUGS],
  [PlanCode.CORPORATE]: BUSINESS_PRO_ENTITLEMENT_SLUGS.filter(
    (slug) => !CORPORATE_EXCLUDED_SLUGS.has(slug),
  ),
};
...
export const SYSTEM_CATALOG_PRODUCTS: Array<{
  ...
  },
  {
    ...
    name: "Categories",
    description: "Product category tree for Retail, Wholesale, and Pharmacy (restaurants use Menu setup)",
    sortOrder: 1,
    navPath: "/catalog/categories",
    navLabel: "Categories",
  },
  {
    id: "sp_pc",
  ...
  },
  {
    ...
    slug: "sales.bill",
    name: "Bills",
    description: "Supplier bills; ledger posts money out when marked paid",
    sortOrder: 7,
    navPath: "/sales/bills",
    navLabel: "Bills",
  },
  {
    id: "sp_sales_settlement",
    serviceId: "svc_sales",
    slug: "sales.settlement",
    name: "DirectPay settlement",
    description: "Request payout of POS digital collections and review wallet fees",
    sortOrder: 8,
    navPath: "/sales/settlement",
    navLabel: "DirectPay settlement",
  },
  {
    id: "sp_rv",
  ...
  },
  {
    id: "sp_arbs",
    serviceId: "svc_finance",
    slug: "accounting.reports.balance_sheet",
    name: "Balance sheet",
    description: "Assets, liabilities, and equity as at a date",
    sortOrder: 4,
    navPath: "/accounting/reports/balance-sheet",
  ...
  },
  {
    id: "sp_agj",
    serviceId: "svc_finance",
    slug: "accounting.journals.general",
    name: "General journal",
    description: "Post balanced debit/credit journal entries without cash or bank settlement",
    sortOrder: 7,
    navPath: "/accounting/journals/general",
    navLabel: "General journal",
  },
  {
    id: "sp_ajrev",
    serviceId: "svc_finance",
    slug: "accounting.journals.reversal",
    name: "Reversed journal",
    description: "Undo a posted journal by swapping debits and credits on the same accounts",
    sortOrder: 8,
    navPath: "/accounting/journals/reversed",
    navLabel: "Reversed journal",
  },
  {
    id: "sp_txjournal",
    serviceId: "svc_finance",
    slug: "accounting.transaction_journal",
    name: "Transaction journal",
    description: "Review and approve GL postings before statements (customer QR/POS sales exempt)",
    sortOrder: 9,
    navPath: "/accounting/transaction-journal",
    navLabel: "Transaction journal",
  },
  {
    id: "sp_sm",
    serviceId: "svc_org",
  ...
  },
  {
    ...
    slug: "activity.log",
    name: "Activity log",
    description: "Audit trail: payments, product changes, and staff actions",
    sortOrder: 6,
    navPath: "/activity-log",
  ...
  {
    id: "sp_merchant_profile",
    serviceId: "svc_merchant",
    slug: "merchant.profile",
    name: "Profile",
    description: "Business profile, logo for documents, and account password",
    sortOrder: 1,
    navPath: "/merchant/profile",
    navLabel: "Profile",
  },
];
