...
- **Customer payments** for orders or approved sales invoices use the **business’s** encrypted gateway credentials (Merchant API), not the platform’s subscription checkout keys.
