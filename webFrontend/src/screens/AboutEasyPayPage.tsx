...
const pillars = [
  ...
  },
  {
    ...
    body:
      'Beyond wallet adapters, the platform supports structured internal partner APIs for trusted server-to-server integrations—useful when another system should provision or synchronize data with EasyPay under your control.',
  },
] as const
    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="relative mx-auto max-w-5xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-teal-400">About EasyPay</p>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-300">
            EasyPay (EASYPAY) brings storefront tools, staff-aware subscriptions, wallet checkout,
      ...
      <article className="mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        <div className="prose prose-slate max-w-none prose-headings:font-bold prose-p:text-slate-600 prose-li:text-slate-600">
          <h2 className="text-2xl text-slate-900">What EasyPay is</h2>
          <p>
            EasyPay is a <strong>multi-tenant web application</strong>: each <strong>business</strong>{' '}
          ...
          <p>
            The product is developed by <strong>Phantom Metrics Ltd</strong> (The Gambia). EasyPay
          ...
          <p>
            The system deliberately separates <strong>what you pay EasyPay</strong> for your
        ...
        <div className="prose prose-slate mt-14 max-w-none prose-p:text-slate-600">
          ...
          <p className="mt-10 text-center text-xs text-slate-500">
            EasyPay is a product of Phantom Metrics Ltd, The Gambia. Features available to your
