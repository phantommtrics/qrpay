  ...
  return (
    <PageTransition>
      <FinanceReportChrome
        ...
        description="Manual and reversal journals on the DirectPay platform chart of accounts (operator-posted only). Use Operator journals to post or reverse entries. For all platform GL activity including subscriptions, see Journal entries."
        toolbar={null}
      >
        <PageCard
          variant="default"
