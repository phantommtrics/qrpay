      ...
      <div className="space-y-6 py-2">
        <PageCard variant="default" className="rounded-md border-qb-border p-5">
          ...
          <p className="mt-2 text-sm text-qb-muted">
            Manual journals and reversals on the DirectPay platform chart of accounts. Merchant business postings
            are under{' '}
            <Link
        ...
        <PageCard variant="default" className="rounded-md border-qb-border p-5">
          ...
          <p className="mt-1 text-sm text-qb-muted">
            Manual journals and reversals on the DirectPay platform chart of accounts (not merchant businesses).
          </p>
